...
>(({ className, children, ...props }, ref) => (
	<DialogPortal>
		...
		>
			{children}
			<DialogPrimitive.Close className="absolute right-4 top-4 text-fg-muted hover:text-amber transition-colors outline-none focus-visible:ring-1 focus-visible:ring-amber">
				<X className="h-4 w-4" />
