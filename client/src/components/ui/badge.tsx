...
const badgeVariants = cva(
	"inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] tracked-sm font-medium border",
	{
		variants: {
			variant: {
				default: "bg-elev2 text-fg border-line",
				secondary: "bg-transparent text-fg-mid border-line",
				destructive: "bg-transparent text-amber-hot border-amber-hot/50",
				outline: "bg-transparent text-fg-mid border-line",
